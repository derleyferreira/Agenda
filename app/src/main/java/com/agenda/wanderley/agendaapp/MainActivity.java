...
public class MainActivity extends AppCompatActivity
    ...
    private TextView txt_Nome_Menu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_Nome_Menu =  navigationView.getHeaderView(0).findViewById(R.id.txt_HeaderMain_Nome);
        txt_Nome_Menu.setText(Global.usuarioLogado.getPesNome());
